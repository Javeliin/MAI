...
Реализация операции сравнения модулей комплексных чисел, сложения, вычитания, умножения, деления, сравнения, нахождение сопряженного
Реализовать операцию сравнения модулей*/
...
int main() {
    double realf, imagf, reals, imags;
    scanf("%lf%lfi", &realf, &imagf);
    scanf("%lf%lfi", &reals, &imags);
    Complex first(realf, imagf), second(reals, imags), result;
